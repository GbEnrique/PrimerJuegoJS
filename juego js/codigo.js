...
const posicionIncialBola=[270,40];
const posicionActualBola =posicionIncialBola; 
...
// Aniadir evento escuchador para el documento de
...
// funcion par cambiar la direccion
...
function gameOver(){
	if(posicionActualBola[1] <=0){
		...
		// puntuacion.innerHTML='Lo siento has perdido recarga la pagina para intentarlo otra vez';
